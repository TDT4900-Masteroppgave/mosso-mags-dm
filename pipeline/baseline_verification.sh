...
./run.sh benchmark --runs 3 --group mags_small --algorithm para_mags para_mags_dm --p 40
./run.sh benchmark --runs 3 --group mags_large --algorithm para_mags para_mags_dm --p 40